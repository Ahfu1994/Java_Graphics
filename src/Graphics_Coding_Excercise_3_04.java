...
public class Graphics_Coding_Excercise_3_04
{
	public static void main(String[] args)
	{
		...
		for (int i = 1; i < data.length; i++)
		{
			...
			g.drawLine(120 + 70 * (i-1), 500-data[i-1], 120 + 70 * i, 500-data[i]);
		}
		...
		{
			g.setColor(new Color(255, 0, 0));
			g.drawLine(120 + 70 * i -20, 500-data[i], 120 + 70 * i + 20, 500-data[i]);
			g.drawLine(120 + 70 * i, 500-data[i]-20, 120 + 70 * i, 500-data[i]+20);
		}
