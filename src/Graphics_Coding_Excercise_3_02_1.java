...
public class Graphics_Coding_Excercise_3_02_1
{
	...
	public static void main(String[] args)
	{
		...
		for (int i = 0; i < data1.length; i++)
		{
			...
			g.fillRect(90 + (80 + 40) * i, 500 - data1[i]*400/height - 1, 40, data1[i]*400/height - 1);

			g.setColor(new Color(0, 0, 255));
			g.fillRect(130 + (80 + 40) * i, 500 - data2[i]*400/height - 1, 40, data2[i]*400/height - 1);
